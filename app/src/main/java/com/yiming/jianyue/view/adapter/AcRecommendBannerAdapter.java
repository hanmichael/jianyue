package com.yiming.jianyue.view.adapter;
...
import com.yiming.jianyue.view.adapter.recyclerview.AcRecommendRvAdapter;
...
public class AcRecommendBannerAdapter extends PagerAdapter {
    private Context mContext =AppClient.getInstance().getApplicationContext();
