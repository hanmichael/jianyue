...
import com.yiming.jianyue.old.view.adapter.AcRecommendBannerAdapter;
import com.yiming.jianyue.old.view.callback.GetAcRecommendHttpResult;
...
/**
 * Created by succlz123 on 2015/7/26.
 */
...
//        holder.setIsRecyclable(false);
    ...
    public void setCardViewInfo(AcReOther.DataEntity.PageEntity.ListEntity entity,
        ...
        if (entity != null) {
            ...
            tvSubTitleOtherLeft.setText(AppClient.getInstance().getApplicationContext().getString(R.string.click) + " " + entity.getViews());
            tvSubTitleOtherRight.setText(AppClient.getInstance().getApplicationContext().getString(R.string.reply) + " " + entity.getComments());
        } else {
