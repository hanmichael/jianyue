...
import com.yiming.jianyue.old.model.bean.acfun.AcContentInfo;
        ...
        if (holder instanceof VideoInfoVH) {
            if (mAcContentInfo != null) {
                ...
                ((VideoInfoVH) holder).tvClick
                        .setText(AppClient.getInstance().getApplicationContext().getString(R.string.click) + " " + contentEntity.getViews());
                ((VideoInfoVH) holder).tvStows
                        .setText(AppClient.getInstance().getApplicationContext().getString(R.string.stows) + " " + contentEntity.getStows());
                ...
                ((VideoInfoVH) holder).tvUid
                        .setText(AppClient.getInstance().getApplicationContext().getString(R.string.uid) + " " + contentEntity.getUser().getUserId());
