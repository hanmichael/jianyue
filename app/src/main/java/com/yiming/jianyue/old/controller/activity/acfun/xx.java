package com.yiming.jianyue.old.controller.activity.acfun;//package org.succlz123.blueboard.ui.activity.acfun;
//
...
//        AdPublic.addAd(BiliVideoViewActivity.this);
//        // 启动定时�?   timer.schedule(task, 0, AdPublic.time);
//    }
//
...
//                Toast.makeText(BiliVideoViewActivity.this, "再按一下退出喵(｡･ω･｡)~", 1).show();
